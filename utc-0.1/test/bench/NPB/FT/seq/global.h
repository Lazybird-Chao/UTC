...
////
extern dcomplex *plane;//[(BLOCKMAX+1)*MAXDIM];
extern dcomplex **scr;//[MAXDIM][BLOCKMAX+1];
extern double ***twiddle;//[NZ][NY][NX+1];
extern dcomplex ***xnt;//[NZ][NY][NX+1];
extern dcomplex ***y;//[NZ][NY][NX+1];
