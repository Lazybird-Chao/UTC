...
__device__  inline void enforce_bc_par(FTYPE *domain_ptr, int i, int j, int w, int h){
	if(i==(w/2-1) && j==0){
...
__device__  inline FTYPE get_var_par(FTYPE *domain_ptr, int i, int j, int w, int h){
	FTYPE ret_val;
