    ...
    if(myTaskid == m_srcId)
    {
        ...
        *m_threadOstream<<"src-thread "<<myThreadRank<<" doing Pwrite...:("<<m_srcId<<"->"<<m_dstId<<")"<<std::endl;
#endif
                // no matter reader comes or not, just pass address
        ...
        {   // has several threads
            ...
            // get op lock and check op counter value to see if need do real write
