...
public:
	...
	virtual int BWriteBy(ThreadRank thread, void* DataPtr, DataSize_t DataSize, int tag)=0;
	virtual void BWriteBy_Finish(int tag)=0;

	virtual int Write(void* DataPtr, DataSize_t DataSize, int tag)=0;
	virtual int WriteBy(ThreadRank thread, void* DataPtr, DataSize_t DataSize, int tag)=0;
	virtual void WriteBy_Finish(int tag)=0;

	virtual int PWrite(void* DataPtr, DataSize_t DataSize, int tag)=0;
	virtual int PWriteBy(ThreadRank thread, void* DataPtr, DataSize_t DataSize, int tag)=0;
